...
namespace SerenityHavenResort.Services
{
    public class TokenService
    {
        ...
        public string GenerateToken(User user, IList<string> roles)
        {
            ...
            // Add customer/employee specific claims if needed
            if (user.UserType == UserType.Guest && user.Customer != null)
            {
                claims.Add(new("CustomerId", user.Customer.Id.ToString()));
            }
            else if ((user.UserType == UserType.Employee || user.UserType == UserType.Manager) && user.Employee != null)
            {
